...
Note:
CIFAKE contains general real-vs-synthetic imagery.
This project adapts those forensic detection techniques specifically for food image fraud detection.
...
AI_Food_Fraud_FINAL_COMBINED.ipynb
2. Enable GPU
